...
//        Log.i(TAG, "bee_push onRegister " + pushId);
...
//        //检查通知栏和透传消息开关状态回调
//        Log.i(TAG, "bee_push pushSwitchStatus " + pushSwitchStatus);
//    }
//
//    @Override
//    public void onRegisterStatus(Context context, RegisterStatus registerStatus) {
//        Log.i(TAG, "bee_push onRegisterStatus " + registerStatus);
//        Log.i(TAG, "bee_push onRegister " + registerStatus.getPushId());
...
//        Log.i(TAG, "bee_push onUnRegisterStatus " + unRegisterStatus);
//        //新版反订阅回调
//    }
//
//    @Override
//    public void onSubTagsStatus(Context context, SubTagsStatus subTagsStatus) {
//        Log.i(TAG, "bee_push onSubTagsStatus " + subTagsStatus);
//        //标签回调
//    }
//
//    @Override
//    public void onSubAliasStatus(Context context, SubAliasStatus subAliasStatus) {
//        Log.i(TAG, "bee_push onSubAliasStatus " + subAliasStatus);
//        //别名回调
//    }
//
//    @Override
